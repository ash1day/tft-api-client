...
export type { Region, RegionGroup, Tier, MatchData, ParticipantData, TraitData, UnitData, } from './types.js';
...
export type { Division, LeagueListDTO, LeagueItemDTO, LeagueEntryDTO, MiniSeriesDTO, SummonerDTO, MatchDTO, MatchMetadataDTO, MatchInfoDTO, MatchParticipantDTO, MatchTraitDTO, MatchUnitDTO, } from './api/types.js';
